...
<?php if(get_field('article_author') || get_field('single_article_social', 'options')) :
		...
		<?php if(get_field('single_article_social', 'options')) : ?>
			<div class="social">
				...
				<div class="socials">
					...
					<div class="social-sharing">
						...
						<img src="<?php echo esc_url (get_template_directory_uri() . '/assets/dist/images/somejakokuvat_facebook.png'); ?>" />
							<span class="screen-reader-text"><?php esc_html_e('Jaa Facebookissa'); ?></span>
						</a>
					</div>
					<?php endif; ?>
					...
					<div class="social-sharing">
						...
						<span class="screen-reader-text"><?php esc_html_e('Jaa Twitterissä'); ?></span>
						</a>
					</div>
					<?php endif; ?>
					...
					<div class="social-sharing">
						...
						<a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo esc_url($url); ?>">
							...
							<span class="screen-reader-text"><?php esc_html_e('Jaa LinkedInissä'); ?></span>
						</a>
				...
				<?php if(get_field('single_article_social_button', 'options')) : ?>
					<?php $link = get_field('single_article_social_button', 'options'); 
					$link_url = $link['url'];
