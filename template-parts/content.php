...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="grid">
		<?php if ( $image ) : ?>
			<?php if ( get_field( 'article_image_icon' ) ) : ?>
	...
	<section class="author-and-sharing <?php echo esc_attr( $section_class ); ?>">
		...
		if ( get_field( 'article_author' ) ) :
			...
			<div class="author-info">
				...
				<a class="email" href="mailto:<?php echo esc_attr( $email ); ?>">
					<?php echo $email_echo; #phpcs:ignore ?>
				</a>
			</div>
		<?php endif; ?>
			...
			<div class="social">
				...
				<div class="socials">
					...
					<div class="social-sharing">
						...
						<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/dist/images/somejakokuvat_facebook.png' ); ?>" alt="" />
					...
					<div class="social-sharing">
						...
						data-size="large">
						<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/dist/images/x_x.png' ); ?>" alt="" />
					...
					<div class="social-sharing">
						...
						<a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo esc_url( $url ); ?>">
							<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/dist/images/somejakokuvat_linkedin.png' ); ?>" alt="" />
				...
				<div class="buttons">
					<a target="<?php echo esc_url( $link_target ); ?>" href="<?php esc_url( $link_url ); ?>" class="button <?php echo esc_html( get_field( 'single_article_social_button_icon', 'options' ) ); ?>">
					<?php if ( 'back' === get_field( 'single_article_social_button_icon', 'options' ) ) : ?>
						<span class="material-symbols">arrow_right_alt</span>
					<?php elseif ( 'rss' === get_field( 'single_article_social_button_icon', 'options' ) ) : ?>
