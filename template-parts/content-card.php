...
<section class="card-toggle-container">
	<div class="grid toggle">
		<button class="sidebar-toggle"
			id="toggleSidebar"
			aria-label="<?php esc_attr_e( 'Valikko', 'topten' ); ?>"
...
<section class="single-card-container">
	<div class="grid sidebar-grid">
		<aside class="sidebar" id="sidebar-menu-mobile">
			<div class="boxes">
								...
								foreach ( $keywords as $index => $keyword ) :
									...
									data-id="<?php echo esc_attr( $keyword->term_id ); ?>">
										<?php if ( ! empty( term_description( $keyword->term_id ) ) ) : ?>
											<button type="button" aria-controls="desc-<?php echo esc_attr( $keyword->term_id ); ?>" aria-expanded="false">
										<?php endif; ?>
										...
										<?php if ( ! empty( term_description( $keyword->term_id ) ) ) : ?>
											<div class="keyword-description-container" id="desc-<?php echo esc_attr( $keyword->term_id ); ?>" role="tooltip">
