...
<section <?php groteski_block_id(); ?> class="<?php echo $class; ?> <?php groteski_focal_point(); ?>">
    <?php if ( 'video' === $select ) : ?>
    ...
    <?php if ( 'carousel' === $select ) :
        if ( have_rows( 'slides' ) ) : ?>
            <div class="splide carousel" aria-labelledby="<?php echo $block['id'] . '_title'; ?>">
                        ...
                        <?php while ( have_rows( 'slides' ) ) : the_row(); ?>
							...
							<?php if ( $image ) : ?>
								...
								<li class="splide__slide">
									<img class="<?php groteski_focal_point( true ); ?>" src="<?php echo $src; ?>" alt="<?php echo $alt; ?>" />
								</li>
							<?php endif; ?>
                        <?php endwhile; ?>
                    </ul>
